...
export function ChapterFiveTopNav() {
  return (
    <header
      id="topNav"
      className="fixed z-50 flex w-full items-center justify-between bg-transparent px-page-margin-mobile py-6 transition-all duration-300 md:px-page-margin-desktop"
    >
      <Link
        to="/"
