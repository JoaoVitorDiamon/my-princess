...
export function ChapterFiveFooter({ links }: ChapterFiveFooterProps) {
  return (
    <footer className="relative z-50 flex w-full flex-col items-center justify-center bg-transparent px-page-margin-mobile py-12 text-center">
